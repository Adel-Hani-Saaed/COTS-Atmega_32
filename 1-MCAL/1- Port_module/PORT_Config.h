...
/********************************************************/
/* Choose the DIRECTION      Option : 0 For Input *******/
/*********************************	: 1 For Output ******/
/********************************************************/
...
/****Option : 0 For Floating if input , Low (0 voltage) if Output ***/
/********   : 1 For PullUP if input , high (5 Voltage ) if output ***/
/************************************************************/


/********************************************************/
/************** For PORTA_INITIAL_VALUE *****************/
/********************************************************/
